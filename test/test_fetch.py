...
class TestFetch(unittest.TestCase):
    ...
    @vcr.use_cassette(
        "test/fixtures/vcr_cassettes/test_fetch_payout_by_budget_user_group.yaml"
    )
    ...
    @vcr.use_cassette(
        "test/fixtures/vcr_cassettes/test_fetch_payout_by_budget_user.yaml"
    )
    def test_fetch_payouts_by_budget_user(self):
        ...
        self.assertEqual(
            row["group_name"], "PRORAČUNSKI UPORABNIK NI ČLAN PODSKUPINE RPU"
        )
        self.assertEqual(
            row["budget_user_name"],
